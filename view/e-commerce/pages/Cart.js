...
import { View, ScrollView, Text, StatusBar, StyleSheet ,Image, TouchableOpacity} from 'react-native';
...
function Cart({navigation}) {
    ...
    const products = [
        ...
        { id: 3, name: 'Product 2', price: '$15',quantity: 3,image:T3},
        { id: 4, name: 'Product 2', price: '$15',quantity: 1,image:T4},
      ];
